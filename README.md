...
- `skills/`   — custom skills (coding-standards, feature, grilling, autopilot, debugging, security-review, documentation, git-commit, audit-solution, self-improve, simple-language, fableize, drunken-genius).
