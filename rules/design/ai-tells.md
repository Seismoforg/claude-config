...
"why"/examples behind it. §9.G (EM-DASH BAN) stays inline in `../design.md` — highest-severity,
...
Em-dashes are not on this list because §9.G bans them outright, everywhere, and that ban stays inline in `../design.md`.
