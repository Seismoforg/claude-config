...
Overriding rule: **match the project's existing design system** — REPO PATTERNS in `.github/blocks.md` governs; here it reads as tokens, components, spacing, conventions.
...
- [ ] Build + typecheck clean (rendered viewport / interaction / visual regressions → LIVE VERIFICATION in `.github/blocks.md`)
...
See `.github/blocks.md` for WHEN UNCERTAIN (for web, prefer MDN/W3C official docs) / AFTER THE TASK / LANGUAGE.
